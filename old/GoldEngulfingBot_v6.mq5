...
//|  v6.0: Added trading session controls (Asian/London/New York)    |
//+------------------------------------------------------------------+
...
int OnInit() {
    Log("========================================", "INIT");
    Log("Gold Engulfing Bot v6.0 Starting", "INIT");
    Log("v5.1: Trade #2 SL = wider of confirmation or 50% engulfing body", "INIT");
    Log("v6.0: Trading session controls (Asian/London/New York)", "INIT");
